...
class RadiodProvider with ChangeNotifier{
  BackImg backImg;
  EssayInfo essayInfo;
  Writers writers;
  ...
  RadiodProvider(){
    ...
    backImg = BackImg(
      backpicture:  "http://www.ruanyifeng.com/blogimg/asset/201211/bg2012111401.jpg",
      backIcon: Icons.keyboard_arrow_left,
      mackIcon: Icons.bookmark_border,
      keepIcon: Icons.bookmark,
      ifBookmark: false,
      backphoto:  "http://st.gde-fon.com/wallpapers_original/587975_lunnyiy-svet_nebo_luna_oblaka_polnaya-luna_zvezdyi_5184x3456_www.Gde-Fon.com.jpg",
      backname: "ONE电台",
