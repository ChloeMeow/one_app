...
class FilmDetail extends StatefulWidget {
  FilmDetail({Key key}) : super(key: key);
...
class _FilmDetailState extends State<FilmDetail> {
  ...
  Widget build(BuildContext context) {
    FilmdProvider provider = Provider.of<FilmdProvider>(context);
    return Scaffold(
...
class EssayContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Html(
        data: provider.essayInfo.essayContent,
      ),
    );
    /*return Container(
      padding: EdgeInsets.only(
...
//文章内容
/*class EssayList extends StatelessWidget {
  const EssayList({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    FilmdProvider provider = Provider.of<FilmdProvider>(context);
    List<Essays> essays = List<Essays>();
    essays = provider.essayInfo.essays;
    return Container(
      padding: EdgeInsets.only(
        left:15,
        right:15
