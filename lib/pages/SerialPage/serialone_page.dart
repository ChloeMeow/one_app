...
import 'package:one_app/pages/SerialPage/Serialjump.dart/chapter_detail.dart';
...
class SerialOnePage extends StatelessWidget {
  const SerialOnePage({Key key}) : super(key: key);
